...
<div class="midback" background="white">
    <div class="container">
      <div class="row">
        <div class="col-md-4">
          <label>
          <!-- <a class="btn btn-info" href="stdntlogin.php">NEW STUDENT</a> -->
          <a align ="right" class="btn btn-info"   href="index.php">LOG OUT</a>
          <a class="btn btn-info"  href="attendstatics.php">BACK PAGE</a>
          <h5>CLICK ID TO VIEW ATTENDANCE</h5>
        </label>
        </div>  
        <div class="col-md-9">
        <h2>STUDENT LIST</h2>
 ...
 -->
          ...
          <tbody>
            ...
            while ($row = mysqli_fetch_array($result2)) 
               ...
               <form action="S1percent.php" method="POST">
		<label id="login">
			<tr>
