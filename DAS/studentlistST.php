...
$sql2 = "SELECT DISTINCT student.s_ID,student.NAME,student.EMAIL,student_class.cl_ID FROM STUDENT,teacher, teacher_class,student_class 
where STUDENT.s_ID=student_class.s_ID
and student_class.s_ID=student.s_ID
and student_class.cl_ID='$cl_ID';";
    ...
    <div class="container">
      <div class="row">
        <div class="col-md-4">
          ...
          <a class="btn" style="background-color: #DBE5FC " href="studentclass.php">BACK PAGE</a>
        </label>
        </div>  
        <div class="col-md-9">
        <h1>STUDENT LIST</h1>
...
<!--                 <a class="btn" border="black" href="index.php">LOG OUT</a>
 -->      </div>
      </div>
